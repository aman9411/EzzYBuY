...
function RenderDish({men}) {
      return(
        <div className="col-12 col-md-5 m-1">
          <Card>
             <CardImg src={men.image} alt={men.name} />
               <CardBody>
...
function RenderDetails({comments, addComment, dishId}) {
  ...
  else if(props.men != null) {
      return (
        <div className="container">
           <div className="row">
            <Breadcrumb>
               <BreadcrumbItem><Link to='/men'>Mens</Link></BreadcrumbItem>
               <BreadcrumbItem active>{props.men.name}</BreadcrumbItem>
            </Breadcrumb>
            <div className="col-12">
              <h3>{props.men.name}</h3>
              <hr />
            </div>
          </div>
        <div className="row">
          <RenderDish men = {props.men} />
